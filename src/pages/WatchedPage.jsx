...
function WatchedPage() {
    ...
    return (
        <div className="watched-page p-8 max-w-6xl mx-auto">
            <h2 className="font-display text-3xl text-cinema-accent mb-6 tracking-wide">Watched</h2>
                    ...
                    <div key={movie.imdbID} className="movie-card bg-cinema-card rounded-lg overflow-hidden shadow-md flex flex-col border border-transparent hover:border-cinema-accent/40 transition-all duration-200">
                        ...
                        <div className="p-4 flex flex-col gap-2 flex-1">
                            ...
                            <textarea
                                ...
                                className="bg-cinema-bg text-white text-sm p-2 rounded-md border border-gray-700 focus:outline-none focus:border-cinema-accent resize-none"
                                rows={2}
                            />
